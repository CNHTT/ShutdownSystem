...
/**
 * author：ct on 2017/10/16 11:29
 * email：cnhttt@163.com
 */


public class TagListAdapter extends BaseListAdapter<String> {
    ...
    public TagListAdapter(Context mContext, List<String> mDatas, HashMap<String, Integer> number) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = ContextUtils.inflate(mContext, R.layout.taglist_layout);
