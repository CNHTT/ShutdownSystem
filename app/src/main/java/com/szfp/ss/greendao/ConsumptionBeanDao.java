...
/** 
 * DAO for table "CONSUMPTION_BEAN".
*/
public class ConsumptionBeanDao extends AbstractDao<ConsumptionBean, Long> {

    public static final String TABLENAME = "CONSUMPTION_BEAN";

    /**
     * Properties of entity ConsumptionBean.<br/>
    ...
    public ConsumptionBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ConsumptionBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CONSUMPTION_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CONSUMPTION_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ConsumptionBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ConsumptionBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public ConsumptionBean readEntity(Cursor cursor, int offset) {
        ConsumptionBean entity = new ConsumptionBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, ConsumptionBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ConsumptionBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ConsumptionBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ConsumptionBean entity) {
